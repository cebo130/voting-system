...
class Secretary extends StatefulWidget {
  ...
  @override
  State<Secretary> createState() =>
      _SecretaryState(profImage: profImage, position: position);
}
...
class _SecretaryState extends State<Secretary> {
  ...
  final Stream<QuerySnapshot> _partiesStream = FirebaseFirestore.instance.collection('secretary').snapshots();
              ...
              children: [
                ...
                FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return snapshot.data!['secBool'] ? Column(
                      children: [
                        Text(
                          snapshot.data!['secBool'] ? 'You voted ${snapshot.data!['sPname']}' : '',
                          style: TextStyle(
                        ...
                        Text(
                          snapshot.data!['secBool'] ? '${snapshot.data!['sName']},' : '',
                          style: TextStyle(
                              color: Colors.green,
                              fontSize: 15,
                              fontWeight: FontWeight.bold),
