...
class Support extends StatefulWidget {
  ...
  State<Support> createState() =>
      _SupportState(profImage: profImage, position: position);
}
...
class _SupportState extends State<Support> {
  ...
  final Stream<QuerySnapshot> _partiesStream = FirebaseFirestore.instance.collection('support').snapshots();
              ...
              children: [
                ...
                FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return snapshot.data!['supBool'] ? Column(
                      children: [
                        Text(
                          snapshot.data!['supBool'] ? 'You voted ${snapshot.data!['sPname']}' : '',
                          style: TextStyle(
                        ...
                        Text(
                          snapshot.data!['supBool'] ? '${snapshot.data!['sName']},' : '',
                          style: TextStyle(
                              color: Colors.green,
                              fontSize: 15,
                              fontWeight: FontWeight.bold),
